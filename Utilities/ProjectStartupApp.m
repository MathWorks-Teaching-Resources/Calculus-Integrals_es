classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Calculus-Integrals_es";
        ImagePath {mustBeFile} = fullfile("Images","AreaUnderCurve.png"); 
    end
    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            ...
            app.WelcomeTitle.Text = "Bienvenido a " + newline + app.ProjectName; 
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.CoverImage.ImageSource = 'AreaUnderCurve.png';
